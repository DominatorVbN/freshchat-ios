...
#define FRESHCHAT_QUICK_REPLY_FRAGMENT 51
#define FRESHCHAT_TEMPLATE_FRAGMENT 1002
#define FRESHHCAT_TEMPLATE_DROPDOWN @"quick_reply_dropdown"
#define FRESHHCAT_TEMPLATE_CARUOSEL @"carousel"
